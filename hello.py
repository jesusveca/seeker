...
#con las Keywords obtendremos una estructura que contiene los resultados de busqueda
   ...
   #print (result_final)
   return render_template('search.html',keywords = query_global, result = result_final, similarities = result_temp, from_date = from_date, to_date = to_date, len_result = result_total_len,method = 'POST')
...
def pagine(page_id):
   ...
   return render_template('search.html', keywords = query_global, result = result_final, similarities = result_temp, from_date = from_date, to_date = to_date, len_result = result_total_len)	
